...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Types</span></a></li>
						<li><a href="{{URL::to('/add-manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Type</span></a></li>
						<li>
						...
						<li><a href="{{URL::to('/product-details')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Product Review</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2019 <a href="#">BD-STORE</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a>web project 2019/MOBIN</a></span>
		</p>
